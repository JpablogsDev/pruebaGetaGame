...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        [Header("Drifting")]
        [Tooltip("Possibility of the vehicle to drift")]
        public bool driftAvailable;
        [Tooltip("Is the vehicle currently skidding ? ")]
        public bool isDrifting;
        [Tooltip("Direction of drifting")]
        ...
        void Awake()
        {
            var kartAppearence = GetComponent<KartAppearence>();
            kartAppearence.InitKartAppearence();
